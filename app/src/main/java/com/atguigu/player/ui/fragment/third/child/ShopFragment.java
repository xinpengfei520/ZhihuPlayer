package com.atguigu.player.ui.fragment.third.child;
...
import com.atguigu.player.ui.fragment.third.child.child.ContentFragment;
import com.atguigu.player.ui.fragment.third.child.child.MenuListFragment;
...
public class ShopFragment extends BaseFragment {
    ...
    private void initView(View view, Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            //replaceFragment(ContentFragment.newInstance("销量排行"), false);
        }
    }
