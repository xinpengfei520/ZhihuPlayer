...
import com.atguigu.player.utils.Utils;
...
public class RecyclerViewFragmentAdapter extends RecyclerView.Adapter<RecyclerViewFragmentAdapter.ViewHolder> {
    ...
    public RecyclerViewFragmentAdapter(Context context, List<NetAudioBean.ListEntity> datas) {
